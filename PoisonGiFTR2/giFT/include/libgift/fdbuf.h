/*
 * $Id: fdbuf.h,v 1.1 2003/10/27 21:52:25 jashton Exp $
 *
 ...
 *
 * @return Number of bytes read without locating the delim string or 0 if
 *         delim was found.  Negative return values have the same result as
 *         in ::fdbuf_fill.
 */
