/*
 * $Id: dataset.h,v 1.1 2003/10/27 21:52:25 jashton Exp $
 *
...
#define DS_CONTINUE 0x01               /**< Continue iteration */
#define DS_BREAK    0x02               /**< Halt iteration */
#define DS_REMOVE   0x04               /**< Remove the current node */
 ...
 */
DatasetNode *dataset_insert_ex (Dataset **d, ds_data_t *key, ds_data_t *value);
